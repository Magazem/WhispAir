...
Working name: **`memoire`**.
Alternatives to consider: `glass-ai` (matches your existing project), `aether`, `mneme`, `journal-os`.
Rename freely before Phase 1 — it touches the repo name and the systemd unit name, nothing more.
